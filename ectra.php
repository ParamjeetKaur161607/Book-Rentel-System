 ...
 */
class BookValidationHandler extends database
{
...
$object_CRUD = new database("localhost", "param", "161607", "SecondStoryBookStore");
$object_validation = new ValidationHandler("localhost", "param", "161607", "SecondStoryBookStore");
$object_BookValidationHandler = new BookValidationHandler("localhost", "param", "161607", "SecondStoryBookStore");
$object_LoginValidationHandler = new LoginValidationHandler("localhost", "param", "161607", "SecondStoryBookStore");
$object_OrderValidationHandler = new OrderValidationHandler("localhost", "param", "161607", "SecondStoryBookStore");
